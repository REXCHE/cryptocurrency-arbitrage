...
Only for cryptocurrency cross platform arbitrage

|	名称	|	描述	|	链接	|	开发语言	|	stars	|
|	------	|	------	|	------	|	------	|	------	|
|	bitcoin-arbitrage	|	Bitcoin arbitrage - opportunity detector	|	https://github.com/maxme/bitcoin-arbitrage	|	Python	|	1633	|
|	binance-trader	|	💰 Cryptocurrency Trading Bot for Binance (Experimental)	|	https://github.com/yasinkuyu/binance-trader	|	Python	|	718	|
...
|	CryptoArbitrageTrader	|	Compares the prices sell / buy for various Altcoins on the exchanges: Coins-E, BTC-e, Vircurex and Crypto-Trade. It executes the Sell / buy trades as arbitrage of given percentage is found.	|	https://github.com/PeanutPower/CryptoArbitrageTrader	|	Python	|	171	|
|	peregrine	|	Detects arbitrage opportunities across over 90 cryptocurrency exchanges in 34 countries	|	https://github.com/wardbradt/peregrine	|	Python	|	137	|
|	threebody	|	Bitcoin/Litecoin Arbitrage System	|	https://github.com/littlekfc/threebody	|	Python	|	126	|
|	crypto-arbitrage	|	Automatic Trading Bot using Triangular or Exchange Arbitrages	|	https://github.com/kelvinau/crypto-arbitrage	|	Python	|	118	|
|	ArbitrageBot	|	Arbitrage bot that currently works on bittrex & poloniex	|	https://github.com/BatuhanUsluel/ArbitrageBot	|	Python	|	109	|
|	triangle-arbitrage	|		|	https://github.com/wequant-org/triangle-arbitrage	|	Python	|	91	|
|	CindicatorArbitrageBot	|		|	https://github.com/Cindicator/CindicatorArbitrageBot	|	Python	|	77	|
|	arbitrage-chances	|	Finding the best arbitrage opportunies for the top 100 cryptocurrencies in python3.	|	https://github.com/reteps/arbitrage-chances	|	Python	|	77	|
|	bitcoin-arbitrage	|	btc搬砖套利程序	|	https://github.com/ucfyao/bitcoin-arbitrage	|	Python	|	57	|
|	bitcoin-arbitrage-bot	|	:chart_with_upwards_trend: Trading bot that finds price variations between various cryptocurrency markets	|	https://github.com/suhithr/bitcoin-arbitrage-bot	|	Python	|	51	|
|	bitrader	|	Bitcoin Arbitrage utilities	|	https://github.com/jr-minnaar/bitrader	|	Python	|	35	|
|	Betting-Arbitrage	|	Arbitrage Alert scanner. Scans odds across Betfair, Pinnacle, William Hill, bet365, Bookmaker, BetOnline, The Greek Sportsbook, JustBet, SportsInteraction, WagerWeb, 5Dimes	|	https://github.com/cribbinm/Betting-Arbitrage	|	Python	|	34	|
|	rtbarbitrage	|	A framework of statistical arbitrage mining in performance-driven display advertising.	|	https://github.com/wnzhang/rtbarbitrage	|	Python	|	34	|
|	arbitrage	|	Arbitrage opportunity in python with bellman-ford	|	https://github.com/rosshochwert/arbitrage	|	Python	|	30	|
|	arbitrage-keeper	|	Maker Keeper Framework: Keeper to arbitrage on OasisDEX, `join`, `exit`, `boom` and `bust`.	|	https://github.com/makerdao/arbitrage-keeper	|	Python	|	19	|
...
|	BitcoinStrategy	|	bitcoin arbitrage between Huobi and Okcoin	|	https://github.com/skenan/BitcoinStrategy	|	Python	|	18	|
|	CryptoMonitor	|	Crypto-currency price arbitrage monitor	|	https://github.com/Aurora-Team/CryptoMonitor	|	Python	|	16	|
|	crypto-arbitrager	|	crypto asset arbitrage opportunity watcher, market maker, hedge and arbitrage	|	https://github.com/artooze/crypto-arbitrager	|	Python	|	15	|
|	arbitrage	|	simple arbitrage	|	https://github.com/mlbright/arbitrage	|	Python	|	13	|
|	BTCeArbitrage	|	A tool for detecting cross-currency arbitrage oportunities within the BTC-e bitcoin exchange	|	https://github.com/chuckatkins/BTCeArbitrage	|	Python	|	13	|
|	triangular	|	a program for triangular arbitrage	|	https://github.com/123noob/triangular	|	Python	|	12	|
|	minitrain	|	minitrain for bitcoin arbitrage	|	https://github.com/xiaojay/minitrain	|	Python	|	12	|
|	bitfinex-arbitrage	|	arbitrage between crypto pairs in Bitfinex	|	https://github.com/donaldng/bitfinex-arbitrage	|	Python	|	12	|
|	DAOETH_Arb	|	Algotrading and arbitrage for DAO and Ethereum	|	https://github.com/jonromero/DAOETH_Arb	|	Python	|	12	|
|	arbloop	|	cryptocurrency trader	|	https://github.com/tcoyze/arbloop	|	Python	|	12	|
|	sponge	|	Cryptocurrency exchange arbitrage	|	https://github.com/jjyr/sponge	|	Python	|	11	|
|	crypto-arbitrage	|	detects arbitrage between, USD, BTC, and ETH and executes trades accordingly on the Coinbase Exchange	|	https://github.com/anthonywittemann/crypto-arbitrage	|	Python	|	9	|
|	amazon-ebay-arb	|	find arbitrage between products on ebay and amazon	|	https://github.com/immexerxez/amazon-ebay-arb	|	Python	|	9	|
|	bitcoin-arbitrage-ui	|	A simple Flask-based GUI for changing the config.json in bitcoin-arbitrage. Writing this for a freelance client who is allowing me to open source everything.	|	https://github.com/ryepdx/bitcoin-arbitrage-ui	|	Python	|	8	|
|	deep_arb	|	A statistical arbitrage trading implementation using daily data and predictive models.	|	https://github.com/mhernan88/deep_arb	|	Python	|	8	|
|	arbitrage	|		|	https://github.com/altfund/arbitrage	|	Python	|	7	|
...
|	Arbot	|	Assistant for arbitrage	|	https://github.com/zouden/Arbot	|	Python	|	2	|
...
|	magic	|	magic the gathering arbitrage	|	https://github.com/choandrew/magic	|	Python	|	1	|
...
|	Cryptocurrency-Arbitrage-Bot	|	This bot buys ETH with BTC at Kraken, transfers the ETH from Kraken to QuadrigaCX, sells the ETH for BTC at QuadrigaCX, and then transfers the BTC back to Kraken.	|	https://github.com/huiwang159/Cryptocurrency-Arbitrage-Bot	|	Python	|	1	|
...
|	arbitrage	|		|	https://github.com/dansejijie/arbitrage	|	Python	|	0	|
...
|	arbitragesystem	|		|	https://github.com/accelerationa/arbitragesystem	|	Python	|	0	|
...
|	cryptoArbitrage	|		|	https://github.com/capitalmarkettools/cryptoArbitrage	|	Python	|	0	|
...
|	rectangle-arbitrage	|		|	https://github.com/yangqichuan/rectangle-arbitrage	|	Python	|	0	|
...
|	vn.trader_Arbitrage	|	An option arbitrage system based on vn.trader of vn.py Project.	|	https://github.com/jessexu117/vn.trader_Arbitrage	|	Python	|	0	|
